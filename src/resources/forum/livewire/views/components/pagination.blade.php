...
<div>
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="Pagination Navigation" class="flex flex-col items-center justify-between">
            ...
            <div class="hiddensm:flex-1 sm:flex sm:flex-col sm:items-center sm:justify-between">
                <div class="my-4">
